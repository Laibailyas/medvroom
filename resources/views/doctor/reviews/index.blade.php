<x-doctor-layout>
    <div class="space-y-10">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div>
                <h1 class="text-4xl font-black tracking-tighter text-slate-900">Reputation Dashboard</h1>
            ...
            <div class="flex items-center gap-3">
                <div class="px-6 py-3 bg-white border border-slate-100 rounded-2xl shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Global Score</p>
                        <p class="text-xl font-black tracking-tighter text-slate-900 mt-0.5">{{ number_format($averageRating, 1) }} / 5.0</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div class="space-y-8">
                <div class="bg-slate-900 rounded-[2.5rem] p-10 text-white shadow-2xl shadow-slate-900/10 relative overflow-hidden group">
                    ...
                    <h3 class="text-2xl font-black tracking-tighter mb-10 relative z-10">Score Distribution</h3>
                    ...
                    <div class="mt-12 pt-10 border-t border-white/5 relative z-10">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest ">Total Verified Reviews</p>
                                <p class="text-3xl font-black tracking-tighter mt-1">{{ $totalReviews }}</p>
                            </div>
            ...
            <div class="lg:col-span-2 space-y-8">
                <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col">
                    <div class="p-8 border-b border-slate-50">
                        <h2 class="text-2xl font-black tracking-tighter text-slate-900 leading-none">Clinical Feedback Feed</h2>
                    ...
                    <div class="divide-y divide-slate-50">
                                ...
                                <div class="flex flex-col md:flex-row md:items-start gap-8">
                                    ...
                                    <div class="flex-1 space-y-4">
                                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                            <div>
                                                <h4 class="text-lg font-black text-slate-900 tracking-tighter">{{ $review->appointment->patientProfile->user->name }}</h4>
                                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Verified Visit • {{ $review->created_at->format('M d, Y') }}</p>
                                            </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <p class="text-sm font-bold text-slate-600 leading-relaxed relative z-10 pl-6">“{{ $review->comment }}”</p>
                                        </div>

                                        @if($review->appointment->notes)
                                            <div class="p-4 bg-slate-50 border-l-4 border-slate-200 rounded-r-xl">
                                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Clinical Context</p>
                                                <p class="text-xs font-bold text-slate-500 ">{{ Str::limit($review->appointment->notes, 100) }}</p>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        @empty
                            <div class="p-20 text-center text-slate-300">
                                ...
                                <h3 class="text-2xl font-black tracking-tighter text-slate-400 uppercase">No Clinical Reviews Yet</h3>
