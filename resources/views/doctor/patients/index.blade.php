<x-doctor-layout>
    <div class="space-y-8">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div>
                <h1 class="text-4xl font-black tracking-tighter text-slate-900">Patient Directory</h1>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-100">
                            <th class="px-8 py-6 text-[10px] uppercase font-black tracking-widest text-slate-400 ">Patient Profile</th>
                            <th class="px-8 py-6 text-[10px] uppercase font-black tracking-widest text-slate-400 ">Contact Info</th>
                            <th class="px-8 py-6 text-[10px] uppercase font-black tracking-widest text-slate-400 ">Clinical Records</th>
                            ...
                            <tr class="group hover:bg-slate-50/50 transition-colors">
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-5">
                                        ...
                                        <div>
                                            <p class="font-black text-slate-900 tracking-tight text-base">{{ $patient->user->name }}</p>
                                            <div class="flex items-center gap-2 mt-0.5">
                                                <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 ">DOB:</span>
                                ...
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-3">
                                        <div class="px-4 py-2 bg-slate-900/5 rounded-xl border border-slate-900/5 text-center min-w-[70px]">
                                            ...
                                            <p class="text-base font-black tracking-tighter text-slate-800 leading-none mt-1">{{ $patient->appointments_count }}</p>
                                        </div>
                                        <p class="text-xs font-bold text-slate-400 leading-tight">Visits with<br>Practice</p>
                                    </div>
                                </td>
                                <td class="px-8 py-6 text-right">
                                    <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity translate-x-4 group-hover:translate-x-0 transition-all duration-300">
                                        <a href="{{ route('doctor.patients.show', $patient) }}" class="px-6 py-3 bg-white border border-slate-200 text-slate-900 rounded-2xl font-black text-xs hover:bg-slate-900 hover:text-white transition-all shadow-sm uppercase tracking-widest">
                                            Open Records
                                        </a>
                                    </div>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-8 py-24 text-center">
                                    ...
                                    <h3 class="text-2xl font-black tracking-tighter text-slate-400">No Patient Records Yet</h3>
