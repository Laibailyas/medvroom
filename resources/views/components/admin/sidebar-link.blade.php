    ...
    <div class="flex items-center flex-1">
        ...
        @switch($icon)
            ...
            @case('specialties')
                ...
                @break
            @case('symptom')
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-3 {{ $active ? 'text-indigo-600' : 'text-slate-400 group-hover:text-slate-500' }}"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>
                @break
            @case('appointment')
            @case('appointments')
            ...
            @case('moderation')
                ...
                @break
            @case('help')
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-3 {{ $active ? 'text-indigo-600' : 'text-slate-400 group-hover:text-slate-500' }}"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.82 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
                @break
            @case('mail')
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-3 {{ $active ? 'text-indigo-600' : 'text-slate-400 group-hover:text-slate-500' }}"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a2 2 0 0 1-2.06 0L2 7"/></svg>
                @break
            @case('payments')
