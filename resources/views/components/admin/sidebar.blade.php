...
<div class="flex flex-col z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto !h-screen !min-h-screen bg-white border-r border-slate-200 w-64 transition-all duration-200 ease-in-out shrink-0"
    ...
    <div class="flex flex-col flex-1 overflow-y-auto overflow-x-hidden py-4 px-4 space-y-6">
        ...
        <!-- Blog Section -->
        <div>
            <h3 class="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Blog</h3>
            <div class="space-y-1">
                <x-admin.sidebar-link :href="route('admin.blog.categories.index')" :active="request()->routeIs('admin.blog.categories.*')" icon="help">
                    Blog Categories
                </x-admin.sidebar-link>
                <x-admin.sidebar-link :href="route('admin.blog.posts.index')" :active="request()->routeIs('admin.blog.posts.*')" icon="article">
                    Blog Posts
                </x-admin.sidebar-link>
            </div>
        </div>
    ...
    <div class="p-4 border-t border-slate-100">
        <div class="bg-slate-50 rounded-lg p-3 flex items-center">
            <div
                class="w-8 h-8 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold mr-3 text-xs">
