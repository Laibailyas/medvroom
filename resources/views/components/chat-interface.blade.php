<div x-data="chatInterface({{ $conversation->id }}, {{ auth()->id() }})" class="bg-white rounded-[2rem] border border-slate-100 shadow-sm flex flex-col h-[500px]">
    <!-- Header -->
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('chatInterface', (conversationId, userId) => ({
            conversationId,
            userId,
            messages: [],
            newMessage: '',
