<x-provider-onboarding-layout currentStep="0">
            ...
            <div class="p-8 lg:p-12">
                <div class="flex flex-col md:flex-row items-center gap-8 mb-12">
                    <div class="w-full md:w-1/2">
                        <h3 class="text-4xl font-bold text-slate-900 tracking-tight leading-tight mb-6">
                            Set up your profile in <span class="text-indigo-600">minutes</span>.
                        </h3>

                        <p class="text-lg text-slate-600 font-normal leading-relaxed mb-8">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-sm font-medium text-slate-700">
                                    Reach thousands of new patients
                                </span>
                            </div>
                ...
                <x-button
                    :href="route('provider.register.account')"
                    size="full"
                    class="py-5 text-lg font-bold uppercase tracking-widest group rounded-2xl shadow-xl shadow-primary/30" style="background-color: #1C55E7; box-shadow: none;"
                >
                    Get Started
                ...
                <p class="text-center mt-6 text-sm font-medium text-slate-400">
