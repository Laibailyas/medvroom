    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-4xl mb-12">
            <h1 class="text-5xl md:text-6xl font-black tracking-tight text-gray-900 mb-6 leading-[1.1]">
                Find and book <span class="text-primary">doctors</span> who actually <span class="text-secondary">care</span>.
            </h1>
            <p class="text-xl text-gray-600 leading-relaxed font-semibold max-w-2xl">
                Read verified patient reviews, see real-time availability, and book your appointment instantly on MedVroom.
            </p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-2 relative z-20">
            <div class="flex flex-col lg:flex-row divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
                ...
                <div class="flex-[1.5] flex items-center gap-3 px-6 py-5">
                    ...
                    <div class="flex-1">
                        <label class="block text-[10px] font-black uppercase tracking-widest text-neutral-dark/60 mb-0.5">Condition / Specialty</label>
                ...
                <div class="flex-1 flex items-center gap-3 px-6 py-5">
                    ...
                    <div class="flex-1">
                        <label class="block text-[10px] font-black uppercase tracking-widest text-neutral-dark/60 mb-0.5">Location</label>
                ...
                <div class="flex-1 flex items-center gap-3 px-6 py-5">
                    ...
                    <div class="flex-1">
                        <label class="block text-[10px] font-black uppercase tracking-widest text-neutral-dark/60 mb-0.5">Insurance Carrier</label>
                ...
                <div class="flex-1 flex items-center gap-3 px-6 py-5">
                    ...
                    <div class="flex-1">
                        <label class="block text-[10px] font-black uppercase tracking-widest text-neutral-dark/60 mb-0.5">Insurance Plan</label>
                ...
                <div class="p-2 flex items-center">
                    <button class="w-full lg:w-32 h-14 bg-primary rounded-xl flex items-center justify-center text-white shadow-lg hover:bg-primary-hover transition-all hover:scale-[1.02] active:scale-95 group">
        ...
        <div class="mt-8 flex items-center gap-6 justify-center lg:justify-start text-xs text-gray-500 font-bold uppercase tracking-wider">
            <span class="flex items-center gap-2">
                <svg class="w-4 h-4 text-secondary" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"/></svg>
                Find by Insurance
            </span>
            <span class="flex items-center gap-2">
                <svg class="w-4 h-4 text-secondary" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"/></svg>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-6 gap-8 text-center">
            ...
            <div class="group cursor-pointer">
                <div class="w-24 h-24 bg-[#f0f4f9] rounded-full flex items-center justify-center text-4xl mb-4 mx-auto group-hover:bg-primary/10 transition-colors duration-300">
                    {{ $item['icon'] }}
                </div>
                <h3 class="text-sm font-bold text-neutral-dark group-hover:text-primary transition-colors">{{ $item['name'] }}</h3>
            </div>
            @endforeach
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-12">
            ...
            <div class="bg-white p-10 rounded-[2.5rem] shadow-sm border border-gray-100 text-center relative group">
                <div class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center text-primary text-2xl font-black mb-6 mx-auto group-hover:scale-110 transition-transform">1</div>
            ...
            <!-- Step 2 -->
            <div class="bg-white p-10 rounded-[2.5rem] shadow-sm border border-gray-100 text-center relative group">
                <div class="w-16 h-16 bg-secondary/10 rounded-2xl flex items-center justify-center text-secondary text-2xl font-black mb-6 mx-auto group-hover:scale-110 transition-transform">2</div>
            ...
            <!-- Step 3 -->
            <div class="bg-white p-10 rounded-[2.5rem] shadow-sm border border-gray-100 text-center relative group">
                <div class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center text-primary text-2xl font-black mb-6 mx-auto group-hover:scale-110 transition-transform">3</div>
...
<section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-end mb-16">
            ...
            <button class="font-bold text-primary hover:underline">View all results &rarr;</button>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/40 p-1 group hover:border-primary/20 transition-all">
                <div class="p-6">
                    <div class="flex gap-5 mb-6">
                        ...
                        <div>
                            <h3 class="text-lg font-black text-gray-900 group-hover:text-primary">{{ $doc['name'] }}</h3>
                            <p class="text-sm font-bold text-gray-400 mb-1">{{ $doc['specialty'] }}</p>
                            <div class="flex items-center gap-1.5 font-black text-neutral-dark text-sm">
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-secondary font-black text-xs uppercase tracking-tighter">{{ $doc['availability'] }}</span>
                            <button class="px-6 py-2.5 bg-primary rounded-xl text-white font-bold text-xs hover:bg-primary-hover transition-all shadow-lg shadow-primary/20 active:scale-95">Book Now</button>
                        </div>
                    </div>
                </div>
            </div>
