<x-admin-layout>
    ...
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('admin.specialties.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-lg font-bold text-sm text-white hover:bg-indigo-700 active:bg-indigo-800 transition shadow-sm">
